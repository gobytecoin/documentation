...
demo: curl -X POST  http://127.0.0.1:12454/wallet/createtransaction -d '{"to_address": "41e9d79cc47518930bc322d9bf7cddd260a0260a8d", "owner_address": "41D1E7A6BC354106CB410E65FF8B181C600FF14292", "amount": 1000 }'
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/gettransactionsign -d '{
...
demo：curl -X POST  http://127.0.0.1:12454/wallet/broadcasttransaction -d '{"signature":["97c825b41c77de2a8bd65b3df55cd4c0df59c307c0187e42321dcc1cc455ddba583dd9502e17cfec5945b34cad0511985a6165999092a6dec84c2bdd97e649fc01"],"txID":"454f156bf1256587ff6ccdbc56e64ad0c51e4f8efea5490dcbc720ee606bc7b8","raw_data":{"contract":[{"parameter":{"value":{"amount":1000,"owner_address":"41e552f6487585c2b58bc2c9bb4492bc1f17132cd0","to_address":"41d1e7a6bc354106cb410e65ff8b181c600ff14292"},"type_url":"type.googleapis.com/protocol.TransferContract"},"type":"TransferContract"}],"ref_block_bytes":"267e","ref_block_hash":"9a447d222e8de9f2","expiration":1530893064000,"timestamp":1530893006233}}'
Parameters：Signed Transaction contract data
Return value：broadcast success or failure

/wallet/updateaccount
Function：Modify account name
demo：curl -X POST  http://127.0.0.1:12454/wallet/updateaccount -d '{"account_name": "0x7570646174654e616d6531353330383933343635353139" ,"owner_address":"41d1e7a6bc354106cb410e65ff8b181c600ff14292"}'
...
demo：curl -X POST  http://127.0.0.1:12454/wallet/votewitnessaccount -d '{
...
demo：curl -X POST  http://127.0.0.1:12454/wallet/createassetissue -d '{
"owner_address":"",
"name":"{{assetIssueName}}",
"abbr": "{{abbrName}}",
"total_supply" :4321,
...
demo：curl -X POST  http://127.0.0.1:12454/wallet/createaccount -d '{"owner_address":"41d1e7a6bc354106cb410e65ff8b181c600ff14292", "account_address": "41e552f6487585c2b58bc2c9bb4492bc1f17132cd0"}'
...
demo：curl -X POST  http://127.0.0.1:12454/wallet/createwitness -d '{"owner_address":"41d1e7a6bc354106cb410e65ff8b181c600ff14292", "url": "007570646174654e616d6531353330363038383733343633"}'
...
demo：curl -X POST  http://127.0.0.1:12454/wallet/transferasset -d '{"owner_address":"41d1e7a6bc354106cb410e65ff8b181c600ff14292", "to_address": "41e552f6487585c2b58bc2c9bb4492bc1f17132cd0", "asset_name": "6173736574497373756531353330383934333132313538", "amount": 100}'
...
Demo: curl -X POST http://127.0.0.1:12454/wallet/easytransfer -d '{"passPhrase": "7465737470617373776f7264","toAddress": "41D1E7A6BC354106CB410E65FF8B181C600FF14292", "amount":10}'
Parameters: passPhrase is the password, converted from ascii to hex. toAddress is the recipient address, converted into a hex string; amount is the amount of GBX to transfer expressed in SUN.
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/easytransferbyprivate -d '{"privateKey": "D95611A9AF2A2A45359106222ED1AFED48853D9A44DEFF8DC7913F5CBA727366", "toAddress":"4112E621D5577311998708F4D7B9F71F86DAE138B5","amount":10000}'
Parameters：passPhrase is the private key in hex string format. toAddress is the recipient address, converted into a hex string; amount is the amount of GBX to transfer in SUN.
...
Demo: curl -X POST http://127.0.0.1:12454/wallet/createaddress -d '{"value": "7465737470617373776f7264" }'
...
demo：curl -X POST -k http://127.0.0.1:12454/wallet/generateaddress
...
demo：curl -X POST http://127.0.0.1:12454/wallet/participateassetissue -d '{
...
Function：Freezes an amount of GBX. Will give bandwidth OR Energy and TRON Power(voting rights) to the owner of the frozen tokens.
demo：curl -X POST http://127.0.0.1:12454/wallet/freezebalance -d '{
...
Parameters：
owner_address is the address that is freezing GBX account，converted to a hex string
frozen_balance is the number of frozen GBX
...
Return value：Freeze GBX transaction raw data

/wallet/unfreezebalance
Function：Unfreeze GBX that has passed the minimum freeze duration. Unfreezing will remove bandwidth and TRON Power.
demo：curl -X POST http://127.0.0.1:12454/wallet/unfreezebalance -d '{
"owner_address":"41e472f387585c2b58bc2c9bb4492bc1f17342cd1",
}'
Parameters：
owner_address address to unfreeze GBX for，converted to a hex string
Return value：Unfreeze GBX transaction raw data

/wallet/unfreezeasset
Function：Unfreeze a token that has passed the minimum freeze duration.
demo：curl -X POST http://127.0.0.1:12454/wallet/unfreezeasset -d '{
"owner_address":"41e472f387585c2b58bc2c9bb4492bc1f17342cd1",
}'
Parameters：
...
demo：curl -X POST http://127.0.0.1:12454/wallet/withdrawbalance -d '{
"owner_address":"41e472f387585c2b58bc2c9bb4492bc1f17342cd1",
}'
Parameters：
owner_address is the address to withdraw from，converted to a hex string
Return value：Withdraw GBX transaction raw data

/wallet/updateasset
Function：Update a Token's information
demo：curl -X POST http://127.0.0.1:12454/wallet/updateasset -d '{"owner_address":"4116440834509C59DE4EE6BA4933678626F451BEFE", "url":"687474", "description":"57732e", "new_limit":1000000, "new_public_limit":1000}'
Parameters：
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/listnodes
Parameters：None
Return value：List of nodes

/wallet/getassetissuebyaccount
Function：List the tokens issued by an account.
demo: curl -X POST  http://127.0.0.1:12454/wallet/getassetissuebyaccount -d '{"address": "41F9395ED64A6E1D4ED37CD17C75A1D247223CAF2D"}'
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/getaccountnet -d '{"address": "4112E621D5577311998708F4D7B9F71F86DAE138B5"}'
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/getassetissuebyname -d '{"value": "44756354616E"}'
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/getassetissuelistbyname -d '{"value": "44756354616E"}'
Parameters：The name of the token, converted to a hex string
Return value：List of tokens.

/wallet/getassetissuebyid(will not be supported until Odyssey-v3.2)
Function：Query token by id.
demo: curl -X POST  http://127.0.0.1:12454/wallet/getassetissuebyid -d '{"value": "1000001"}'
Parameters：The id of the token, it's a string
Return value：token.

/wallet/getnowblock
Function：Query the latest block
demo: curl -X POST  http://127.0.0.1:12454/wallet/getnowblock
Parameters：None
Return value：Latest block on full node

/wallet/getblockbynum
Function：Query block by height
demo: curl -X POST  http://127.0.0.1:12454/wallet/getblockbynum -d '{"num" : 100}' 
Parameters：Num is the height of the block
Return value：specified Block object

/wallet/getblockbyid
Function：Query block by ID
demo: curl -X POST  http://127.0.0.1:12454/wallet/getblockbyid -d '{"value": "0000000000038809c59ee8409a3b6c051e369ef1096603c7ee723c16e2376c73"}'
Parameters：Block ID.
Return value：Block Object

/wallet/getblockbylimitnext
Function：Query a range of blocks by block height
demo: curl -X POST  http://127.0.0.1:12454/wallet/getblockbylimitnext -d '{"startNum": 1, "endNum": 2}'
Parameters：
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/getblockbylatestnum -d '{"num": 5}'
Parameters：The number of blocks to query
Return value：A list of Block Objects

/wallet/gettransactionbyid
Function：Query transaction by ID
demo: curl -X POST  http://127.0.0.1:12454/wallet/gettransactionbyid -d '{"value": "d5ec749ecc2a615399d8a6c864ea4c74ff9f523c2be0e341ac9be5d47d7c2d62"}'
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/gettransactioncountbyblocknum -d '{"num" : 100}' 
Parameters：Num is the height of the block.
Return value：Transaction count.

wallet/listwitnesses
Function：Query the list of Super Representatives
demo: curl -X POST  http://127.0.0.1:12454/wallet/listwitnesses
Parameters：None
Return value：List of all Super Representatives

/wallet/getassetissuelist
Function：Query the list of Tokens
demo: curl -X POST  http://127.0.0.1:12454/wallet/getassetissuelist
Parameters：None
Return value：List of all Tokens

/wallet/getpaginatedassetissuelist
Function：Query the list of Tokens with pagination
demo: curl -X POST  http://127.0.0.1:12454/wallet/getpaginatedassetissuelist -d '{"offset": 0, "limit": 10}'
...
demo: curl -X POST  http://127.0.0.1:12454/wallet/totaltransaction
Parameters：None
Return value：Total number of transactions.

/wallet/getnextmaintenancetime
Function：Get the time of the next Super Representative vote
demo: curl -X POST  http://127.0.0.1:12454/wallet/getnextmaintenancetime
Parameters：None
...
Parameters：
  ...
  fee_limit：Maximum GBX consumption, measured in SUN（1GBX = 1,000,000SUN）
  call_value：Amount of GBX transferred with this transaction, measured in SUN（1GBX = 1,000,000SUN）
